...
# 1296 = 362. What is remarkable is that, by using the same digital substitutions, the anagram, RACE, also forms a square number: 
...
# Step one: Find pairs of anagrams (this is probably the most time-consuming bit)
# Step two: Test for squareness 
# Step three: Find out why the difficulty level of this problem is so high, I guess